...
export class AuthService {
  ...
  // 	"phone_number": "01785XXXXXXX",
  // 	"type": "admin",
  // 	"gender": "male",
  // 	"date_of_birth": "2000-08-25T04:43:02.400Z",
  // 	"created_at": "2025-08-25T04:43:02.400Z"
  // }
  ...
  async disableAccount(user_id: string) {
    try {
      ...
      if (user.status === 0) {
        return { success: false, message: 'Account is already disabled' };
      }

      await UserRepository.disableAccount(user_id);
      return {
        success: true,
  ...
  async enableAccount(user_id: string) {
    try {
      ...
      await UserRepository.enableAccount(user_id);
      return {
        success: true,
